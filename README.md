...
<head>
    ...
    <title>Radiator Apps | Современные решения для отопления</title>
    <style>
        ...
        :root {
            ...
            --border: #FFD1DC;
            --header-text: #FFFFFF;
            --gradient: linear-gradient(135deg, #FF4D8D 0%, #FF85A2 100%);
        ...
        [data-theme="dark"] {
            ...
            --card-bg: #1A1740;
            --border: #2A266B;
            --gradient: linear-gradient(135deg, #6D5DFD 0%, #8B7DFF 100%);
        }
            ...
            <div class="app-grid">
                ...
                <div class="card app-card" id="mobile-app">
                    <div class="app-image floating" style="animation-delay: 0.5s;">
                        <img src="images/screenshots/mobile-version.webp" alt="Скриншот мобильного приложения">
